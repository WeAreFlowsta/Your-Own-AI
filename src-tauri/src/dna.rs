...
/// the bundle's v1; v4-v7 = + get_conversations_page and
...
/// record, ~0.3 s each on a large cell; v7 reads windows of six or fewer by
/// `get`, since one chain scan costs about six of them. v4-v6 never left the
/// dev box).
pub const COORDINATOR_VERSION: u32 = 7;
